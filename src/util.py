...
def parse_arguments():
    ...
    parser.add_argument('--eval_mode', type=str, default="small", choices=["small", "large", "sd", "para_sd", "para_sd_wo_1", "para_sd_wo_2", "pld_para_sd"], help='eval mode.')
    ...
    parser.add_argument('--pld_max_ngram_size', type=int, default=3, help='PLD maximum n-gram size for matching.')
    parser.add_argument('--pld_num_pred_tokens', type=int, default=5, help='PLD number of candidate tokens to return.')
