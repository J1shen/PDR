...
class Decoding(ABC):
    ...
    def parallel_speculative_decoding_with_pld(self, prefix):
        """Wrapper around the standalone PLD parallel decoder helper."""
        prefix, draft_inc, target_inc = parallel_speculative_decoding_with_pld(
            ...
            seed=self.seed,
            num_acc_tokens=self.num_acc_tokens,
        )
        self.draft_forward_times += draft_inc
        self.target_forward_times += target_inc
        return prefix
